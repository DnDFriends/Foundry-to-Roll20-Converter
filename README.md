...
After this build is deployed, use this cache-busting address once:

`https://dndfriends.github.io/foundry-roll20-converter/?v=2026.09.07.3`

The page keeps that build query in the address automatically. Update `BUILD` in `index.html` when publishing a future version.
